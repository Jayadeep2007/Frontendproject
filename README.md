...
navigate to the HTML, CSS, and JavaScript program listing pages. A fourth card
(and the "Portfolio" link in the header) opens the personal portfolio site at
`portfolio/index.html`. Every
...
├── portfolio/              (personal portfolio site — index.html, css/, js/, assets/)
